...
const sessionSlides: Record<number, Slide[]> = {
  ...
  2: [
    ...
    slide(
      ...
      'A clean science discussion visual showing a warm-water diffusion cup beside four connected icon cards: warm water, faster particle motion, wider color plume, and evidence check mark, no readable words, no labels, no letters.',
      'diffusion-temperature',
      'discussion',
      'diagram',
      [
