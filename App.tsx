...
const GENERATION_CACHE_VERSION = 'lesson-plan-cache-v26';
const IMAGE_SEMANTIC_CACHE_VERSION = 'image-semantic-cache-v18';
...
const CURATED_STATIC_IMAGE_ASSET_VERSION = '20260530-digestive-medical-hd1';
